...
public class PanelTicketNuevo
    ...
    private void localInit() {
         ...
         * en el FuncionComboBoxModel*/
        this.comboBoxFuncion.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                // Produce eventos de selección y deselección (solo queremos uno).
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    /* Va a estar habilitado solo si la funcion elegida 
                     * tiene disponibilidad.*/
                    btnGuardar.setEnabled(controlador.cambiaFuncion(info,
                            comboBoxFuncion.getModel().getSelectedItem()));
