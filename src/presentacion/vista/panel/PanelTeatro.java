...
import presentacion.modelo.TeatroTableModel;
 ...
 * @author marces
 */
public class PanelTeatro
        extends javax.swing.JPanel
        implements VistaPadre {

    private ControladorTeatro controlador;
    ...
    private void initComponents() {
        ...
        libro.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Teatros", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 18))); // NOI18N

        tablaTeatros.setModel(new TeatroTableModel());
        jScrollPane2.setViewportView(tablaTeatros);
    ...
    public void setControlador(Controlador controlador) {
        this.controlador = (ControladorTeatro) controlador;
    }
    ...
    public void actualizar() {
        ((TeatroTableModel) tablaTeatros.getModel()).update();
    }
...
//</editor-fold>
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        controlador.eliminarTeatro(
                (ATableModel) tablaTeatros.getModel(),
                tablaTeatros.getSelectedRow());
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed

        controlador.nuevoTeatro();
    }//GEN-LAST:event_btnNuevoActionPerformed

    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
      
        controlador.modificarTeatro(
                (ATableModel) tablaTeatros.getModel(),
                tablaTeatros.getSelectedRow());
